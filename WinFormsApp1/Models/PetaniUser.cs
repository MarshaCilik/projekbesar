...
{
    public class PetaniUser : Users
    {
        public PetaniUser(int id, string username, string password, string nama, string noTelp, string email,
        ...
        {
            new DashboardPetani(this.Username).Show();
        }
    }
}
