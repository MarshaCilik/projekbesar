...
namespace WinFormsApp1.Controller
{
    public class KaryawanController
    {
        ...
        public DataTable GetStokBarang()
        {
            ...
            using (NpgsqlConnection conn = connectDB.GetConnection())
            {
                // Using view 'lihat_barang_petani' as requested
        ...
        public DataTable GetStokAlat()
        {
            ...
            using (NpgsqlConnection conn = connectDB.GetConnection())
            {
                // Using view 'lihat_alat' as requested
        ...
        public DataTable GetLaporanStok(string jenis)
        {
            ...
            using (NpgsqlConnection conn = connectDB.GetConnection())
            {
                ...
                if (jenis == "produk")
                    ...
                    sql = "SELECT * FROM audit_stok_barang_alat;"; // Make sure this table exists in DB
        ...
        public DataTable GetLaporanDenda()
        {
            ...
            using (NpgsqlConnection conn = connectDB.GetConnection())
            {
                // Filter out any that are already Lunas
        ...
        public void LunaskanDenda(int detailSewaId)
        {
            using (NpgsqlConnection conn = connectDB.GetConnection())
            {
                // Calculate denda first or assume it's calculated in view. We just update status_sewa
